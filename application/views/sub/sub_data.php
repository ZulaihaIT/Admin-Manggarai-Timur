...
<div class="right_col" role="main">
    ...
    <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data as $d) {
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo base_url('assets/sub/') . $d->gambar?>" class="img-thumbnail" /></td>
                                                <td><?php
                                                ...
                                                <td>
                                                    <button onclick="update('<?php echo $d->id_sub ?>')" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i>Edit</button>
                                                    <button onclick="remove('<?php echo $d->id_sub ?>')" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i>Delete</button>
                                                </td>
                                            </tr>
                                            <?php
                                            $no++;
        ...
        <?php $this->load->view('sub/sub_modal'); ?>
    </div>
</div>
...
<script>
    ...
    function remove(id) {
        ...
        if (con) {
            var del = "<?php echo site_url('hapus-sub/') ?>";
            $.ajax({
                url: del,
                type: 'POST',
                data: {id: id},
    ...
    function update(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('sub-id') ?>/" + id,
            type: "GET",
            dataType: "JSON",
